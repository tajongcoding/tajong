                ...
                >
                  <div className="p-6 flex flex-col h-full">
                    ...
                    <div className="mb-4 flex flex-wrap justify-between items-center gap-2">
                       <span className="text-[13px] font-[600] text-[#0F1A2B] bg-[#F5F7FA] px-2.5 py-1 rounded border border-slate-200 group-hover:border-[#C9A857] transition-colors">
                         {post.category}
                       </span>
                    ...
                    <h3 className="text-[18px] font-[700] text-[#1F2937] mb-3 group-hover:text-[#0F1A2B] transition-colors line-clamp-2 leading-snug break-keep">
                      {post.title}
                    </h3>
                    
                    <p className="text-[#6B7280] text-[15px] leading-relaxed mb-6 line-clamp-3 break-keep flex-grow">
                      {post.summary}
                    </p>

                    {/* Bottom read more */}
                    <div className="mt-auto pt-4 border-t border-slate-100 flex items-center text-[#1F2937] font-[600] text-[14px] group-hover:text-[#C9A857] transition-colors">
